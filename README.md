...
Write down the version of KeeneticOS (e.g. `4.00.C.6.0-0`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20240529_1619_KN-1010-4.00.C.6.0-0.bin`)
