...
Write down the version of KeeneticOS (e.g. `4.02.C.1.0-1`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20241008_1716_KN-1010-4.02.C.1.0-1.bin`)
