...
Write down the version of KeeneticOS (e.g. `4.02.C.6.3-1`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20250423_1825_KN-1010-4.02.C.6.3-1.bin`)
