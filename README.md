...
Write down the version of KeeneticOS (e.g. `4.00.C.5.0-1`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20240529_1610_KN-1010-4.00.C.5.0-1.bin`)
