...
Write down the version of KeeneticOS (e.g. `4.03.C.3.0-2`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20250609_1447_KN-1010-4.03.C.3.0-2.bin`)
