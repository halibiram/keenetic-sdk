...
define KernelPackage/crypto-ansi-cprng
  TITLE:=Software Pseudo Random Number Generator
  DEPENDS:=+kmod-crypto-aes +kmod-crypto-rng
  KCONFIG:=CONFIG_CRYPTO_ANSI_CPRNG
  FILES:=$(LINUX_DIR)/crypto/ansi_cprng.ko
  $(call AddDepends/crypto)
endef
$(eval $(call KernelPackage,crypto-ansi-cprng))
...
define KernelPackage/crypto-seqiv
  ...
  DEPENDS:=+kmod-crypto-aead +kmod-crypto-rng +kmod-crypto-ansi-cprng
...
define KernelPackage/crypto-chacha20
  TITLE:=ChaCha20 cipher CryptoAPI module
...
define KernelPackage/crypto-poly1305
  TITLE:=Poly1305 cipher CryptoAPI module
...
define KernelPackage/crypto-chacha20poly1305
  TITLE:=ChaCha20Poly1305 AEAD cipher CryptoAPI module
  DEPENDS:=+kmod-crypto-chacha20 +kmod-crypto-poly1305 +kmod-crypto-aead
...
define KernelPackage/crypto-lzo
  TITLE:=LZO CryptoAPI module
  DEPENDS:=+kmod-lib-lzo +kmod-crypto-manager
...
define KernelPackage/crypto-zlib
  ...
  KCONFIG:=CONFIG_CRYPTO_ZLIB
  FILES:=$(LINUX_DIR)/crypto/zlib.ko
  $(call AddDepends/crypto)
endef

$(eval $(call KernelPackage,crypto-zlib))
