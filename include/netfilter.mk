...
# kernel only
$(eval $(if $(NF_KMOD),$(call nf_add,NF_IPT,CONFIG_IP_NF_IPTABLES=y, $(P_V4)ip_tables),))
$(eval $(if $(NF_KMOD),$(call nf_add,NF_IPT,CONFIG_NETFILTER_XTABLES=y, $(P_XT)x_tables),))

$(eval $(if $(NF_KMOD),$(call nf_add,IPT_CORE,CONFIG_NETFILTER_XTABLES=y, $(P_XT)xt_tcpudp),))
$(eval $(if $(NF_KMOD),$(call nf_add,IPT_CORE,CONFIG_IP_NF_FILTER=y, $(P_V4)iptable_filter),))
$(eval $(if $(NF_KMOD),$(call nf_add,IPT_CORE,CONFIG_IP_NF_MANGLE=y, $(P_V4)iptable_mangle),))

# userland only
$(eval $(if $(NF_KMOD),,$(call nf_add,IPT_CORE,CONFIG_IP_NF_IPTABLES, xt_standard ipt_icmp xt_tcp xt_udp xt_comment xt_set xt_SET)))

$(eval $(call nf_add,IPT_CORE,CONFIG_NETFILTER_XT_MATCH_LIMIT=y, $(P_XT)xt_limit))
...
$(eval $(call nf_add,IPT_CORE,CONFIG_NETFILTER_XT_TARGET_TCPMSS=y, $(P_XT)xt_TCPMSS))
$(eval $(call nf_add,IPT_CORE,CONFIG_IP_NF_TARGET_REJECT=y, $(P_V4)ipt_REJECT))
...
# kernel only
$(eval $(if $(NF_KMOD),$(call nf_add,NF_CONNTRACK,CONFIG_NF_CONNTRACK=y, $(P_XT)nf_conntrack),))
$(eval $(if $(NF_KMOD),$(call nf_add,NF_CONNTRACK,CONFIG_NF_CONNTRACK_RTCACHE=y, $(P_XT)nf_conntrack_rtcache),))
$(eval $(if $(NF_KMOD),$(call nf_add,NF_CONNTRACK,CONFIG_NF_DEFRAG_IPV4=y, $(P_V4)nf_defrag_ipv4),))
$(eval $(if $(NF_KMOD),$(call nf_add,NF_CONNTRACK,CONFIG_NF_CONNTRACK_IPV4=y, $(P_V4)nf_conntrack_ipv4),))
$(eval $(if $(NF_KMOD),$(call nf_add,NF_CONNTRACK,CONFIG_NF_CONNTRACK_CUSTOM=2,),))
$(eval $(if $(NF_KMOD),$(call nf_add,NF_CONNTRACK,CONFIG_NF_CT_PROTO_UDPLITE=y, $(P_XT)nf_conntrack_proto_udplite),))
...
$(eval $(call nf_add,IPT_EXTRA,CONFIG_NETFILTER_XT_TARGET_NFQUEUE, $(P_XT)xt_NFQUEUE))
$(eval $(call nf_add,IPT_EXTRA,CONFIG_NETFILTER_NETLINK_QUEUE, $(P_XT)nfnetlink_queue))

# ipopt

$(eval $(call nf_add,IPT_IPOPT,CONFIG_NETFILTER_XT_NDMMARK=y, $(P_XT)xt_ndmmark))
...
$(eval $(call nf_add,IPT_IPOPT_EXTENDED,CONFIG_NETFILTER_XT_MATCH_STRING, $(P_XT)xt_string))

$(eval $(call nf_add,IPT_IPOPT_EXTENDED,CONFIG_NETFILTER_XT_MATCH_DSCP, $(P_XT)xt_dscp))
...
$(eval $(call nf_add,IPT_IPOPT_EXTENDED,CONFIG_NETFILTER_XT_MATCH_STATISTIC, $(P_XT)xt_statistic))

$(eval $(call nf_add,IPT_IPOPT_EXTENDED,CONFIG_NETFILTER_XT_TARGET_CLASSIFY, $(P_XT)xt_CLASSIFY))
$(eval $(call nf_add,IPT_IPOPT_EXTENDED,CONFIG_IP_NF_MATCH_DSCP, $(P_V4)ipt_dscp))
$(eval $(call nf_add,IPT_IPOPT_EXTENDED,CONFIG_IP_NF_TARGET_ECN, $(P_V4)ipt_ECN))
...
# userland only
$(eval $(if $(NF_KMOD),,$(call nf_add,IPT_IPOPT_EXTENDED,CONFIG_NETFILTER_XT_MATCH_DSCP, $(P_XT)xt_tos)))
$(eval $(if $(NF_KMOD),,$(call nf_add,IPT_IPOPT_EXTENDED,CONFIG_NETFILTER_XT_TARGET_DSCP, $(P_XT)xt_TOS)))
$(eval $(if $(NF_KMOD),,$(call nf_add,IPT_IPOPT_EXTENDED,CONFIG_NETFILTER_XT_MATCH_HL, ipt_ttl)))
$(eval $(if $(NF_KMOD),,$(call nf_add,IPT_IPOPT,CONFIG_NETFILTER_XT_TARGET_HL, ipt_TTL)))

$(eval $(call nf_add,IPT_IPOPT_EXTENDED,CONFIG_NETFILTER_XT_MATCH_HL, $(P_XT)xt_hl))
$(eval $(call nf_add,IPT_IPOPT,CONFIG_NETFILTER_XT_TARGET_HL=y, $(P_XT)xt_HL))
...
# kernel only
$(eval $(if $(NF_KMOD),$(call nf_add,NF_IPT6,CONFIG_IP6_NF_IPTABLES=y, $(P_V6)ip6_tables),))

$(eval $(if $(NF_KMOD),$(call nf_add,NF_CONNTRACK6,CONFIG_NF_DEFRAG_IPV6=y, $(P_V6)nf_defrag_ipv6),))
$(eval $(if $(NF_KMOD),$(call nf_add,NF_CONNTRACK6,CONFIG_NF_CONNTRACK_IPV6=y, $(P_V6)nf_conntrack_ipv6),))

$(eval $(if $(NF_KMOD),$(call nf_add,IPT_IPV6,CONFIG_IP6_NF_FILTER=y, $(P_V6)ip6table_filter),))
$(eval $(if $(NF_KMOD),$(call nf_add,IPT_IPV6,CONFIG_IP6_NF_MANGLE=y, $(P_V6)ip6table_mangle),))
...
$(eval $(call nf_add,IPT_IPV6,CONFIG_IP6_NF_TARGET_REJECT=y, $(P_V6)ip6t_REJECT))
$(eval $(call nf_add,IPT_IPV6,CONFIG_IP6_NF_TARGET_REJECT=y, $(P_V6)nf_reject_ipv6))
...
# kernel only
$(eval $(if $(NF_KMOD),$(call nf_add,NF_NAT,CONFIG_NF_NAT=y, $(P_XT)nf_nat),))
$(eval $(if $(NF_KMOD),$(call nf_add,NF_NAT,CONFIG_NF_NAT_NEEDED=y,),))
...
$(eval $(call nf_add,IPT_NAT,CONFIG_IP_NF_TARGET_MASQUERADE=y, $(P_V4)ipt_MASQUERADE))
$(eval $(call nf_add,IPT_NAT,CONFIG_IP_NF_TARGET_MASQUERADE=y, $(P_V4)nf_nat_masquerade_ipv4))
$(eval $(call nf_add,IPT_NAT,CONFIG_IP_NF_TARGET_REDIRECT=y, $(P_XT)xt_REDIRECT))
...
$(eval $(call nf_add,NF_NATHELPER_ESP,CONFIG_NF_CT_PROTO_ESP, $(P_XT)nf_conntrack_proto_esp))
...
$(eval $(call nf_add,NF_NATHELPER_PPTP,CONFIG_NF_CT_PROTO_GRE, $(P_XT)nf_conntrack_proto_gre))
$(eval $(call nf_add,NF_NATHELPER_PPTP,CONFIG_NF_NAT_PROTO_GRE, $(P_V4)nf_nat_proto_gre))

# ipt-ndm-extra

$(eval $(call nf_add,IPT_NDM_EXTRA,CONFIG_NETFILTER_XT_MATCH_CONNSKIP=y, $(P_XT)xt_connskip))
$(eval $(call nf_add,IPT_NDM_EXTRA,CONFIG_NETFILTER_XT_TARGET_PPE=y, $(P_XT)xt_PPE))
$(eval $(call nf_add,IPT_NDM_EXTRA,CONFIG_NETFILTER_XT_MATCH_TLS=y, $(P_XT)xt_tls))
...
# kernel only
$(eval $(if $(NF_KMOD),$(call nf_add,IPT_TPROXY,CONFIG_NETFILTER_TPROXY, $(P_XT)nf_tproxy_core),))
