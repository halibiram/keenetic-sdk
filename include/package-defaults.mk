...
PKG_DEFAULT_DEPENDS = +libc +SSP_SUPPORT:libssp
...
define Package/Default
  ...
  PROVIDES:=
  EXTRA_DEPENDS:=
  MAINTAINER:=Keenetic Developers Team <developers@keenetic.com>
...
ifneq ($(TARGET_LTO_FLAGS),)
  TARGET_CFLAGS   += $(TARGET_LTO_FLAGS)
  TARGET_CXXFLAGS += $(TARGET_LTO_FLAGS)
  TARGET_LDFLAGS  += $(TARGET_LTO_FLAGS) $(TARGET_OPTIMIZATION)
endif
...
define Build/Compile/Default
	+$(MAKE_VARS) \
	$(MAKE) $(PKG_JOBS) -C $(PKG_BUILD_DIR)/$(PKG_MAKE_PATH) \
		$(MAKE_FLAGS) \
		$(1);
endef
